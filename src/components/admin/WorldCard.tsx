        ...
        {world.header_image_url ? (
          world.header_image_url.includes('drive.google.com') ? (
            ...
            <Image
              ...
              unoptimized={shouldUseUnoptimizedImage(convertGoogleDriveUrl(world.header_image_url))}
            />
          )
        ) : (
              ...
              <div className="relative w-8 h-8 flex-shrink-0">
                {world.icon_url.includes('drive.google.com') ? (
                  ...
                  <Image
                    ...
                    unoptimized={shouldUseUnoptimizedImage(convertGoogleDriveUrl(world.icon_url))}
                  />
                )}
              </div>
            )}
