 ...
 * After `.single()` / `.maybeSingle()`, assert via `as unknown as YourRowType` — `data` may
 * infer as `GenericStringError`, and TS forbids casting that directly to your row interface.
 */
