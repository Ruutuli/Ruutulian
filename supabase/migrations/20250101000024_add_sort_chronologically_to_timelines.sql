...
-- Idempotent: do not mass-UPDATE rows here — re-running migrations would wipe user preferences.
-- New column uses DEFAULT true; existing rows receive that default when the column is first added.
